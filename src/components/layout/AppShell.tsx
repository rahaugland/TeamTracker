...
import { PlayerBottomTabBar } from '@/components/layout/PlayerBottomTabBar';
...
export function AppShell({ children }: AppShellProps) {
  ...
  const getNavigation = () => {
    if (isPlayer) {
      return [
        { name: t('navigation.home'), href: '/player/home', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
        { name: t('navigation.schedule'), href: '/player/schedule', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
        { name: t('navigation.stats'), href: '/player/stats', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
        { name: t('navigation.goals'), href: '/player/goals', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
        { name: t('navigation.profile'), href: '/player/profile', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
      ];
    }
  ...
  return (
    <div className="min-h-screen bg-navy">
      {/* Mobile header - player gets simplified header, others get hamburger */}
      {isPlayer ? (
        <PlayerMobileHeader />
      ) : (
      ...
      <div className="flex">
        ...
        <div className="flex-1 min-w-0 flex flex-col">
          ...
          {/* Main content area */}
          <main className={cn('flex-1 lg:mt-[60px] p-6', isPlayer && 'pb-24 lg:pb-6')}>
            {children}
          </main>
        </div>
      </div>

      {/* Bottom tab bar - player mobile only */}
      {isPlayer && <PlayerBottomTabBar />}
    </div>
  );
}
